...
/**
 * LiquidGlass — ported from glasscn-components.vercel.app/r/liquid-glass.json
 * Renders an SVG feDisplacementMap refractive lens (Chromium-only; degrades to blur elsewhere).
 * Only used when glassVariant === "liquid-refract".
 */
  ...
  return (
    <>
      <div
        ref={setRefs}
        className={cn(
          "relative overflow-hidden rounded-full bg-[#F5ECDA]/08",
          className,
        )}
      ...
      >
        ...
        <span
          ...
          style={{
            padding: 0.5,
            background:
              "linear-gradient(to right, rgba(245,236,218,0), rgba(245,236,218,0.25) 18%, rgba(245,236,218,0.25) 82%, rgba(245,236,218,0)), " +
              "linear-gradient(to bottom, rgba(42,30,20,0), rgba(42,30,20,0.2) 18%, rgba(42,30,20,0.2) 82%, rgba(42,30,20,0))",
